...
export const BOSSES: Boss[] = [
  ...
  // 凱伊
  { id: 'kain_normal', name: '(普)凱伊', groupKey: 'kain', maxPartySize: 1, difficulty: 'normal', allowReset: false, crystalValue: 0, erionVestiges: 0, image: './images/bosses/kain.webp', isSeasonal: true, excludeFromWeeklyLimit: true, seasonBadge: 'S3'},
  { id: 'kain_hard', name: '(困)凱伊', groupKey: 'kain', maxPartySize: 1, difficulty: 'hard', allowReset: false, crystalValue: 0, erionVestiges: 0, image: './images/bosses/kain.webp', isSeasonal: true, excludeFromWeeklyLimit: true, seasonBadge: 'S3'}
];
