...
export const BOSSES: Boss[] = [
  ...
  // 瑪麗希亞
  { id: 'maricia_normal', name: '(普)瑪麗希亞', groupKey: 'maricia', maxPartySize: 3, difficulty: 'normal', allowReset: false, crystalValue: 150000000, erionVestiges: 0, image: './images/bosses/maricia.png' },
];
